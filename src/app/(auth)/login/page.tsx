'use client'
import { Input, InputError, Label, AuthCard, Checkbox } from '@/components/basics';
...
import { PersonalFinanceSvg, BusinessFinanceSvg, OverwhelmingSvg } from '@/components/icons';
                    ...
                    <div className='flex justify-center flex-col items-center gap-y-10'>
                        <div className='flex justify-center flex-col items-center gap-y-5'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-2xl md:text-3xl font-bold text-akauntme'>Sign In to Akauntme</h1>
                                <p className='mt-2 md:mt-5 font-base italic text-indigo-500'>Your Smart Accounting Padi... </p>
                            </div>
                        </div>
                        ...
                        <form className='w-full justify-center flex flex-col items-center gap-y-5'>
                            ...
                            <button type='submit' className="flex justify-center bg-gradient-to-bl from-akauntme to-violet-600 font-semibold lg:text-xl py-3 rounded-lg shadow-lg shadow-akauntme/70 transition-all hover:scale-95 w-9/12 md:w-6/12 text-center text-white">
                                Sign In
                            </button>
                        </form>

                        <div>
                            Don&apos;t have an account? <Link href="/account-type" className="text-akauntme font-semibold">Sign Up</Link>
                        </div>
                            ...
                            >
                                <SwiperSlide>
                                    <div className='text-center h-[80vh]'>
                                        ...
                                        <h2 className='text-2xl font-semibold'>Get Akauntme for Personal Use:</h2>
                                        <div className='flex justify-center mt-10'>

                                            <p className='font-[400] max-w-[600px] text-center leading-7'>
                                                Take control of your finances and time like never before with Akauntme! Budget effortlessly, track expenses seamlessly, and achieve your goals with ease. It's your personal finance and productivity companion, helping you thrive in every aspect of life.
                                            </p>
                                        </div>
                                    ...
                                    <div className='text-center h-[80vh]'>
                                        ...
                                        <div className='flex justify-center mt-10'>
                                            ...
                                            <p className='font-[400] max-w-[600px] text-center leading-7'>
                                                ...
                                                From sales tracking to expense management, our all-in-one solution streamlines your operations and maximizes profitability. Stay ahead of the curve with powerful insights and effortless organization.
                                            </p>
                                        </div>
                                        <div className='flex justify-center items-center'>
                                ...
                                <SwiperSlide>
                                    <div className='text-center h-[80vh]'>
                                        ...
                                        <h2 className='text-2xl font-semibold'>Get Akauntme for Both Personal and Business package:</h2>
                                        <div className='flex justify-center mt-10'>

                                            <p className='font-[400] max-w-[600px] text-center leading-7'>
                                                From paycheck to profit, Akauntme has you covered! Manage your money smarter, schedule like a pro, and watch your success soar. Whether you're running a business or planning your next big adventure, Akauntme is your ultimate accountability partner.
                                            </p>
                                        </div>
