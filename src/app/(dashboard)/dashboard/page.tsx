...
const Page = () => {
  ...
  return (
    <main className="mb-10 flex flex-col gap-y-8">
      <div className="flex flex-col">
        <div className="grid lg:grid-cols-3 lg:grid-rows-3 gap-y-5 lg:gap-y-4 lg:gap-x-4 ">
          <section className=" lg:row-span-3 lg:mt-3 lg:max-h-[670px] relative bg-white dark:bg-akauntme-dark rounded-md border dark:border-akauntme/20 shadow-sm">
            {newItems ? (
              <motion.div
        ...
        shadow-akauntme/30 h-[80vh] lg:shadow-none w-full mt-1 lg:mt-0 py-10 rounded-lg lg:rounded-none border-t lg:border-none
         bg-white dark:bg-akauntme-dark lg:bg-transparent lg:flex px-4 lg:py-6 overflow-x-hidden overflow-y-auto  custom-scrollbar mb-5`}
          ...
          {/* grid  gap-4 sm:gap-6 */}
          <section className="lg:max-h-[200px] lg:col-span-2  items-center flex gap-x-1 justify-between w-full">
            {/* Total balances  */}
            <article className="w-full  flex flex-col justify-center bg-white border-2 hover:border-akauntme shadow-sm rounded-xl dark:bg-akauntme-dark dark:border-akauntme/20">
