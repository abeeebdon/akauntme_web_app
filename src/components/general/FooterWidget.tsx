...
export default function FooterWidget() {
    return (
        <footer className="bg-gradient-to-tr from-akauntme-deep to-akauntme border-t border-white">
                ...
                <div className="lg:flex">
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <div>
                                <h3 className="text-gray-100 tracking-wide uppercase  font-semibold">
                                    Partners
                                </h3>
                                <a
                                    href="#"
